...
\begin{figure}[htb]
\centering{
\subfigure[TCP throughput with psudo TCP connection\label{fig.tcp_usetcp_nonat}]{\includegraphics[width=0.49\linewidth]{fig/tcp_usetcp_nonat.eps}}
\subfigure[TCP throughput with UDP Wrapper\label{fig.tcp_useudp_nonat}]{\includegraphics[width=0.49\linewidth]{fig/tcp_useudp_nonat.eps}}
}
...
\begin{figure*}[htb]
\centering{
\subfigure[Throughput among MPIP, MPTCP and Together for no limit\label{fig.no_limitc}]{\includegraphics[width=0.24\linewidth]{fig/no_limit.eps}}
\subfigure[Delay among different paths for no limit\label{fig.delay_comp_no_limit}]{\includegraphics[width=0.24\linewidth]{fig/delay_comp_no_limit.eps}}
\subfigure[Queuing Delay among different paths for no limit\label{fig.queuing_delay_comp_no_limit}]{\includegraphics[width=0.24\linewidth]{fig/queuing_delay_comp_no_limit.eps}}
\subfigure[Throughput among different paths for no limit\label{fig.tp_comp_no_limit}]{\includegraphics[width=0.24\linewidth]{fig/tp_comp_no_limit.eps}}
}
...
\begin{figure*}[htb]
\centering{
\subfigure[Throughput among MPIP, MPTCP and Together for limit\label{fig.limitc}]{\includegraphics[width=0.24\linewidth]{fig/limit.eps}}
\subfigure[Delay among different paths for limit\label{fig.delay_comp_limit}]{\includegraphics[width=0.24\linewidth]{fig/delay_comp_limit.eps}}
\subfigure[Queuing Delay among different paths for limit\label{fig.queuing_delay_comp_limit}]{\includegraphics[width=0.24\linewidth]{fig/queuing_delay_comp_limit.eps}}
\subfigure[Throughput among different paths for limit\label{fig.tp_comp_limit}]{\includegraphics[width=0.24\linewidth]{fig/tp_comp_limit.eps}}
}
...
\begin{figure*}[htb]
\centering{
\subfigure[Throughput among MPIP, MPTCP and Together for wireless\label{fig.wirelessc}]{\includegraphics[width=0.24\linewidth]{fig/wireless.eps}}
\subfigure[Delay among different paths for wireless\label{fig.delay_comp_wireless}]{\includegraphics[width=0.24\linewidth]{fig/delay_comp_wireless.eps}}
\subfigure[Queuing Delay among different paths for wireless\label{fig.queuing_delay_comp_wireless}]{\includegraphics[width=0.24\linewidth]{fig/queuing_delay_comp_wireless.eps}}
\subfigure[Throughput among different paths for wireless\label{fig.tp_comp_wireless}]{\includegraphics[width=0.24\linewidth]{fig/tp_comp_wireless.eps}}
}
...
\begin{figure*}[htb]
\centering{
\subfigure[out-of-order process\label{fig.outoforder}]{\includegraphics[width=0.33\linewidth]{fig/reorder.eps}}
\subfigure[Skype Audio Streaming Routing Adaptation\label{fig.skype}]{\includegraphics[width=0.33\linewidth]{fig/skype.eps}}
\subfigure[Connection Smooth Switch\label{fig.switch}]{\includegraphics[width=0.33\linewidth]{fig/switch.eps}}
}
\end{figure*}
