...
\label{fig.nolimit}]{\includegraphics[width=0.33\linewidth,height=1.4in]{fig/no_limit.eps}}
\subfigure[Path throughput Comparison for MPIP
\label{fig.nolimittpcomp}]{\includegraphics[width=0.33\linewidth,height=1.4in]{fig/no_limit_tp_comp.eps}}
\subfigure[Path Queuing Delay Comparison for MPIP
\label{fig.nolimitqdcomp}]{\includegraphics[width=0.33\linewidth,height=1.4in]{fig/no_limit_qd_comp.eps}}
}
\caption{Side-by-side comparison without any limitation}
\label{fig.no_limit}
\end{figure*}
