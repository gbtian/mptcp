...
%out of order
data1 = csvread('Z:\home\bill\gbtian\research\kernel\mptcp\conext14\experiment\data\1\no_sack_no_outoforder.csv');
data2 = csvread('Z:\home\bill\gbtian\research\kernel\mptcp\conext14\experiment\data\1\no_sack_outoforder.csv');
...
%clock
data1 = csvread('Z:\home\bill\gbtian\research\kernel\mptcp\conext14\experiment\data\2\clock.csv');
d1=data1(:,4);
x=1:5:size(d1)*5;
...
data1 = csvread('Z:\home\bill\gbtian\research\kernel\mptcp\conext14\experiment\data\3\tcp.csv');
data2 = csvread('Z:\home\bill\gbtian\research\kernel\mptcp\conext14\experiment\data\3\psudo_tcp.csv');
data3 = csvread('Z:\home\bill\gbtian\research\kernel\mptcp\conext14\experiment\data\3\udp_tcp.csv');
d1=conv(data1(:,1), wts, 'valid');
d2=conv(data2(:,1), wts, 'valid');
...
%routing
data1 = csvread('Z:\home\bill\gbtian\research\kernel\mptcp\conext14\experiment\data\9\routing_no_ack.csv');
data2 = csvread('Z:\home\bill\gbtian\research\kernel\mptcp\conext14\experiment\data\9\routing_ack.csv');
d1=conv(data1(:,1), wts, 'valid');
d2=conv(data2(:,1), wts, 'valid');
...
%two paths
data1 = csvread('Z:\home\bill\gbtian\research\kernel\mptcp\conext14\experiment\data\12\1.csv');
data2 = csvread('Z:\home\bill\gbtian\research\kernel\mptcp\conext14\experiment\data\12\2.csv');
...
%skype
data1 = csvread('Z:\home\bill\gbtian\research\kernel\mptcp\conext14\experiment\data\8\noskype\mpip.csv');
data2 = csvread('Z:\home\bill\gbtian\research\kernel\mptcp\conext14\experiment\data\8\skype\mpip.csv');
...
data1 = csvread('Z:\home\bill\gbtian\research\kernel\mptcp\conext14\experiment\data\8\noskype\delay.csv');
data2 = csvread('Z:\home\bill\gbtian\research\kernel\mptcp\conext14\experiment\data\8\skype\delay.csv');
